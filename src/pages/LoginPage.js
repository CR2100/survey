...
export default function LoginPage() { 
    ...
    const register = () => {
      ...
      ,{}
        ...
        if(response.status === 200){
            console.log('lets go')
            //setSubmitted(true); 
            swal("Registration Successful!", "Welcome "+usernameReg+"!", "success");

        }
        if(response.status === 201){
            
            swal("Registration Unsuccessful!", 'username '+usernameReg+" already exists!", "error");
    ...
    const login = () => {
      ...
      ,{}
        ...
        if(response.status === 200){
            //setSubmitted(true);
            swal("Login Successful!", "Welcome back "+usernameLog+"!", "success");
